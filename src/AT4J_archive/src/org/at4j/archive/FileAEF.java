 ...
 * @since 1.0
 */
public final class FileAEF extends AbstractConvenientFilter<ArchiveEntry<?, ?>> implements ArchiveEntryFilter
{
	/**
	 * This singleton instance may be used instead of instantiating the filter.
	 */
	public static final FileAEF FILTER = new FileAEF();

	public boolean matches(ArchiveEntry<?, ?> object)
	{
		return object instanceof ArchiveFileEntry<?, ?>;
	}
}
