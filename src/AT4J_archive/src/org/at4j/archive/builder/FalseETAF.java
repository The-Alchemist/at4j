...
import org.entityfs.support.filter.FalseFilter;
 ...
 * @since 1.0
 */
public final class FalseETAF extends FalseFilter<EntryToArchive> implements EntityToArchiveFilter
{
	/**
	 * Since this object does not contain any internal state, this singleton
	 * instance may be used instead of creating new objects.
	 */
	public static final FalseETAF FILTER = new FalseETAF();
}
