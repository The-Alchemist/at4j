...
/**
 * This filter matches Tar directory entries. It can be used with the
 ...
 * @see TarFileEntryFilter
 */
public final class TarDirectoryEntryFilter extends AbstractConvenientFilter<TarEntryHeaderData> implements TarEntryHeaderDataFilter
{
	/**
	 * The singleton instance.
	 */
	public static final TarDirectoryEntryFilter FILTER = new TarDirectoryEntryFilter();
