...
/**
 * This object represents a file entry created with a POSIX-1.1988 (ustar)
 ...
 */
public class UstarFileEntry extends TarFileEntry implements UstarEntry
{
	private final String m_ustarVersion;
	private final String m_ownerUserName;
	private final String m_ownerGroupName;

	UstarFileEntry(TarEntryHeaderData hd, long startPosOfFileData, TarEntryCollaborator collaborator)
	{
