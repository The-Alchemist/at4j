...
/**
 * This is the "Reduced3" compression method. It is currently not supported.
 * <p>
 ...
 * @since 1.0
 */
public class Reduced3CompressionMethod extends AbstractUnsupportedCompressionMethod implements ZipEntryCompressionMethodFactory
{
	/**
	 ...
	 */
	public static final UnsignedShort CODE = UnsignedShort.valueOf(4);

	public static final String NAME = "Reduced3";
	 ...
	 */
	public static final Reduced3CompressionMethod INSTANCE = new Reduced3CompressionMethod();

	/** Hidden constructor. */
	private Reduced3CompressionMethod()
	{
		// Nothing
	}
	...
	public Reduced3CompressionMethod create(ZipGeneralPurposeBitFlags gbBitFlags)
	{
		return this;
	}
