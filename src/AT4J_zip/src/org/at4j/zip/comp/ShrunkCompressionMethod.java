 ...
 * @since 1.0
 */
public class ShrunkCompressionMethod extends AbstractUnsupportedCompressionMethod implements ZipEntryCompressionMethodFactory
{
	/**
	 ...
	 */
	public static final UnsignedShort CODE = UnsignedShort.valueOf(1);

	public static final String NAME = "Shrunk";
	 ...
	 */
	public static final ShrunkCompressionMethod INSTANCE = new ShrunkCompressionMethod();

	/** Hidden constructor. */
	private ShrunkCompressionMethod()
	{
		// Nothing
	}
