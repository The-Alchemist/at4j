...
/**
 * This is the "PKWare Imploding" compression method. It is currently not
 * supported.
 * <p>
 ...
 * @since 1.0
 */
public class PKWareImplodingCompressionMethod extends AbstractUnsupportedCompressionMethod implements ZipEntryCompressionMethodFactory
{
	/**
	...
	public static final String NAME = "PKWARE Imploding";
	 ...
	 */
	public static final PKWareImplodingCompressionMethod INSTANCE = new PKWareImplodingCompressionMethod();

	/** Hidden constructor. */
	private PKWareImplodingCompressionMethod()
	{
		// Nothing
	}
	...
	public PKWareImplodingCompressionMethod create(ZipGeneralPurposeBitFlags gbBitFlags)
	{
		return this;
	}
