...
/**
 * This is the "WavPack" compression method. It is currently not supported.
 * <p>
 ...
 * @since 1.0
 */
public class WavPackCompressionMethod extends AbstractUnsupportedCompressionMethod implements ZipEntryCompressionMethodFactory
{
	/**
	 ...
	 */
	public static final UnsignedShort CODE = UnsignedShort.valueOf(97);

	public static final String NAME = "WavPack";
	 ...
	 */
	public static final WavPackCompressionMethod INSTANCE = new WavPackCompressionMethod();

	/** Hidden constructor. */
	private WavPackCompressionMethod()
	{
		// Nothing
	}
	...
	public WavPackCompressionMethod create(ZipGeneralPurposeBitFlags gbBitFlags)
	{
		return this;
	}
