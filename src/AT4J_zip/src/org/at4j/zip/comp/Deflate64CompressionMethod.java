...
/**
 * This is the "Deflate64" compression method. It is currently not supported.
 * <p>
 ...
 * @since 1.0
 */
public class Deflate64CompressionMethod extends AbstractUnsupportedCompressionMethod implements ZipEntryCompressionMethodFactory
{
	/**
	 ...
	 */
	public static final UnsignedShort CODE = UnsignedShort.valueOf(9);
	 ...
	 */
	public static final UnsignedShort VERSION_NEEDED_TO_EXTRACT = UnsignedShort.valueOf(21);

	/**
	 * Singleton instance. This is used instead of instantiating this class.
	 */
	public static final Deflate64CompressionMethod INSTANCE = new Deflate64CompressionMethod();

	/** Hidden constructor. */
	private Deflate64CompressionMethod()
	{
		// Nothing
	}
	...
	public Deflate64CompressionMethod create(ZipGeneralPurposeBitFlags gbBitFlags)
	{
		return this;
	}
