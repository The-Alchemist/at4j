...
/**
 * This is the "IBM Terse" compression method. It is currently not supported.
 * <p>
 ...
 * @since 1.0
 */
public class IbmTerseCompressionMethod extends AbstractUnsupportedCompressionMethod implements ZipEntryCompressionMethodFactory
{
	/**
	 ...
	 */
	public static final UnsignedShort CODE = UnsignedShort.valueOf(18);

	public static final String NAME = "IBM Terse";
	 ...
	 */
	public static final IbmTerseCompressionMethod INSTANCE = new IbmTerseCompressionMethod();

	/** Hidden constructor. */
	private IbmTerseCompressionMethod()
	{
		// Nothing
	}
	...
	public IbmTerseCompressionMethod create(ZipGeneralPurposeBitFlags gbBitFlags)
	{
		return this;
	}
