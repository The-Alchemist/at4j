...
/**
 * This is the "Reduced4" compression method. It is currently not supported.
 * <p>
...
public class Reduced4CompressionMethod extends AbstractUnsupportedCompressionMethod implements ZipEntryCompressionMethodFactory
{
	 ...
	 */
	public static final UnsignedShort CODE = UnsignedShort.valueOf(5);

	public static final String NAME = "Reduced4";
	 ...
	 */
	public static final Reduced4CompressionMethod INSTANCE = new Reduced4CompressionMethod();

	/** Hidden constructor. */
	private Reduced4CompressionMethod()
	{
		// Nothing
	}
	...
	public Reduced4CompressionMethod create(ZipGeneralPurposeBitFlags gbBitFlags)
	{
		return this;
	}
