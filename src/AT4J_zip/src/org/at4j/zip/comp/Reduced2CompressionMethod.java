...
/**
 * This is the "Reduced2" compression method. It is currently not supported.
 * <p>
 ...
 * @since 1.0
 */
public class Reduced2CompressionMethod extends AbstractUnsupportedCompressionMethod implements ZipEntryCompressionMethodFactory
{
	/**
	 ...
	 */
	public static final UnsignedShort CODE = UnsignedShort.valueOf(3);

	public static final String NAME = "Reduced2";
	 ...
	 */
	public static final Reduced2CompressionMethod INSTANCE = new Reduced2CompressionMethod();

	/** Hidden constructor. */
	private Reduced2CompressionMethod()
	{
		// Nothing
	}
	...
	public Reduced2CompressionMethod create(ZipGeneralPurposeBitFlags gbBitFlags)
	{
		return this;
	}
