...
/**
 * This is the "IBM LZ77" compression method. It is currently not supported.
 * <p>
 ...
 * @since 1.0
 */
public class IbmLz77CompressionMethod extends AbstractUnsupportedCompressionMethod implements ZipEntryCompressionMethodFactory
{
	/**
	 ...
	 */
	public static final UnsignedShort CODE = UnsignedShort.valueOf(19);

	public static final String NAME = "IBM LZ77";
	 ...
	 */
	public static final IbmLz77CompressionMethod INSTANCE = new IbmLz77CompressionMethod();

	/** Hidden constructor. */
	private IbmLz77CompressionMethod()
	{
		// Nothing
	}
	...
	public IbmLz77CompressionMethod create(ZipGeneralPurposeBitFlags gbBitFlags)
	{
		return this;
	}
