...
/**
 * This is the "Imploded" compression method. It is currently not supported.
 * <p>
...
public class ImplodedCompressionMethod extends AbstractUnsupportedCompressionMethod implements ZipEntryCompressionMethodFactory
{
	 ...
	 */
	public static final UnsignedShort CODE = UnsignedShort.valueOf(6);

	public static final String NAME = "Imploded";
	 ...
	 */
	public static final ImplodedCompressionMethod INSTANCE = new ImplodedCompressionMethod();

	/** Hidden constructor. */
	private ImplodedCompressionMethod()
	{
		// Nothing
	}
	...
	public ImplodedCompressionMethod create(ZipGeneralPurposeBitFlags gbBitFlags)
	{
		return this;
	}
