...
public final class UnsignedInteger implements Serializable, Comparable<UnsignedInteger>
{
	...
	public static UnsignedInteger readBigEndian(RandomAccess ra) throws UnexpectedEofException, WrappedIOException
	{
		...
		if (noRead != 4)
		{
			throw new UnexpectedEofException("Wanted to read 4 bytes. Got " + noRead);
		}
	 ...
	 * The most significant byte is the last byte read.
	 ...
	 * @throws WrappedIOException On I/O errors.
	 */
	public static UnsignedInteger readBigEndian(InputStream is) throws UnexpectedEofException, WrappedIOException
	{
		byte[] barr = new byte[4];
		try
		{
